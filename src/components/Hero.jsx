...
export default function Hero() {
  useEffect(() => {
    gsap.fromTo('.ipad-wrapper', { opacity: 0, scale: 0.6, rotateY: -20 }, { opacity: 1, scale: 1, rotateY: 0, duration: 1.4, ease: 'power3.out', delay: 0.3 })
    gsap.fromTo('.ipad-glow', { opacity: 0, scale: 0 }, { opacity: 1, scale: 1, duration: 1, ease: 'power3.out', delay: 0.5 })
    gsap.fromTo('.ipad-badge', { opacity: 0, scale: 0, y: 30 }, { opacity: 1, scale: 1, y: 0, duration: 0.6, ease: 'back.out(2)', stagger: 0.15, delay: 0.8 })
  }, [])

  return (
    <section id="home" className="min-h-screen flex items-center justify-center px-4 pt-20 relative scroll-mt-20">
      <div className="max-w-6xl mx-auto w-full flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
        <div className="flex-1 text-center lg:text-left animate-fade-in">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-primary/10 border border-primary/20 rounded-full mb-4 sm:mb-6">
            ...
            <span className="text-primary text-xs sm:text-sm font-medium">Available for opportunities</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center lg:justify-start justify-center gap-3">
            ...
            ><i className="fa-solid fa-folder-open mr-2"></i>View Projects</a>
            ...
            ><i className="fa-solid fa-paper-plane mr-2"></i>Contact Me</a>
          </div>
          <div className="flex items-center justify-center lg:justify-start gap-3 sm:gap-4 mt-6 sm:mt-8">
            ...
            ><i className="fa-brands fa-github text-sm sm:text-base text-gray-400 hover:text-primary"></i></a>
            <a href="https://www.linkedin.com/in/amit1924" target="_blank" rel="noreferrer"
              className="w-8 h-8 sm:w-10 sm:h-10 bg-dark-card border border-white/10 rounded-lg flex items-center justify-center hover:border-primary/50 hover:bg-primary/10 transition-all"
            ><i className="fa-brands fa-linkedin-in text-sm sm:text-base text-gray-400 hover:text-primary"></i></a>
          </div>
        </div>
        <div className="flex-1 flex justify-center items-center">
          <div className="ipad-wrapper">
            ...
            <div className="ipad-badge ipad-badge-1"><i className="fa-brands fa-react"></i></div>
            <div className="ipad-badge ipad-badge-2"><i className="fa-brands fa-node-js"></i></div>
            <div className="ipad-badge ipad-badge-3"><i className="fa-solid fa-fire"></i></div>
            <div className="ipad-badge ipad-badge-4"><i className="fa-brands fa-docker"></i></div>
          </div>
        </div>
      </div>
